...
@section('title', __('varenykyLocale::admin.languages.create.title'))

@section('content_header')
    <strong>{{ __('varenykyLocale::admin.languages.create.title') }}</strong>
@stop

@section('save-btn', route('admin.languages.store'))
@section('back-btn', route('admin.languages.index'))

@section('content')

        <form action="{{ route('admin.languages.store') }}" method="POST" id="nopulpForm" enctype="multipart/form-data">
            @csrf
            <div class="row">
